...
import {getMecanicsFromIdGame,getThemesFromIdGame, updateGame, getAllGames, getGamesByTheme, getThemeNames, addGame, getConfigFromMainGame, getConfigFromID, removeGame, getGames, getMechanicNames, linkGameMecanisme, linkGameTheme, AddConfig, AddExtension, LinkExtension, GetConfigByGameName} from '../models/gameModels';
...
/* GET mecanics from id of a game */
router.get('/mecanics/:id', getMecanicsFromIdGame);

/* GET mecanics from id of a game */
router.get('/themes/:id', getThemesFromIdGame);
